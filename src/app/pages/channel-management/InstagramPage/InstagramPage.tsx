...
import InstagramConfigurationModal from "./ConfigurationModal/ConfigurationModal";
      ...
      <div className="card mb-5 mb-xl-10" id="kt_profile_details_view">
        <div className="card-header ">
          <div className="card-title m-0">
            <h3 className="fw-bolder m-0">Instagram Configuration Details</h3>
          </div>
        ...
        <div className="card-body p-9">
          <div className="row mb-7">
            ...
            <div className="col-lg-8">
              <span className="fw-bolder fs-6 text-gray-900">Instagram</span>
            </div>
          </div>
