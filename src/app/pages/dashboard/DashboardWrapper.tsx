  ...
  <>
    ...
    <div className="row g-5 g-xl-8">
      ...
      <div className="col-xl-4">
        <Box
          className="card bg-success card-xl-stretch mb-xl-8"
            ...
            <Box>
              <div className="head-text" style={{ position: "relative" }}>
                <div className="head-image">
                  <img
                    src={
                      "https://img.freepik.com/free-vector/blue-curve-background_53876-113112.jpg?w=1060&t=st=1706704708~exp=1706705308~hmac=a54930b9534eb8736c96b017656e1f61dc34097247ba60a235c43993defc2d53"
                    }
                    height={150}
                    width={300}
                  />
                ...
                >
                  <span>
                    <b>Manage Templates by clicking below</b>
                  </span>
                </div>
              </div>
    ...
    <div className="row g-5 g-xl-8">
      <div className="col-xl-4">
        <Box
          className="card bg-info card-xl-stretch mb-xl-8"
          style={{ backgroundColor: "" }}
        >
          <Box className="card-body">
            <br />
      ...
      <div className="col-xl-4">
        <Box
          className="card bg-white card-xl-stretch mb-xl-9"
          style={{ backgroundColor: "" }}
        >
          <ChannelUtilization />
        </Box>
    ...
    <div className="row g-5 g-xl-8">
      <div className="col-xl-4">
        <Box
          className="card bg-warning card-xl-stretch mb-xl-8"
          style={{ backgroundColor: "" }}
        >
          <Box className="card-body">
            <br />
        ...
        >
          <Box className="card-body">
            ...
            <h3 style={{ color: "white", textAlign: "center" }}>
              Write to us for any new features that you may need
            </h3>
            <center>
              {/* <button
      ...
      <div className="col-xl-4">
        <Box
          className="card bg-dark card-xl-stretch mb-xl-8"
          style={{ backgroundColor: "" }}
        >
          <Box className="card-body">
            <br />
